...
Это метка на уровне типов, в рантайме она не стоит ничего. Нужна она затем, чтобы проверку правил, пришедших из базы или по сети, нельзя было тихо пропустить. А когда обойти её действительно надо — скажем, вы намеренно собираете сломанные правила в тесте — остаётся заметное приведение `as CheckedRules`.
